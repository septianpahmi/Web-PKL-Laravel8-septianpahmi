...
<main id="main" class="main">
    ...
    <div class="card">
        <div class="card-body">
          ...
          <!-- No Labels Form -->
          <form class="row g-3" action="{{url('/nilai/tambah/post')}}" method="POST">
            @csrf
            <div class="col-md-12">
            ...
            <div class="col-md-6">
              <input type="number" name="disiplin" class="form-control" placeholder="Disiplin dalam kerja">
            </div>
            <div class="col-md-6">
              <input type="number" name="kerjasama" class="form-control" placeholder="Kerja sama tim">
            </div>
