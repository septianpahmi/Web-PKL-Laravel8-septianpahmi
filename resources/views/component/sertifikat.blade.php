        ...
        <table class="table table-hover">
          ...
          <tbody>
            <tr align="center">
              ...
              <td>
                <a href="{{url('/sertifikat/save', $item->id)}}" class="btn btn-danger" target="_blank">Simpan PDF</a>
                <a href="{{url('/sertifikat/print', $item->id)}}" class="btn btn-success" target="_blank">Print</a>
              </td>
            </tr>
          </tbody>
          @endforeach
